<h1 align="center"><img width="500" src="https://github.com/HaveFunTrading/boomnet/blob/564a67d22e841eed48aa8a1db9cf7c7847ec281d/docs/thumbnail.png"/></h1>
...
```toml
[dependencies]
boomnet = { version = "0.0.16", features = ["full"]}
```
